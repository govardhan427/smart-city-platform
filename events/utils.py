        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 550px; margin: 0 auto;">
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <div style="background-color: #ffffff; padding: 12px; border-radius: 12px; display: inline-block; margin-bottom: 20px;">
                                    <img src="data:image/png;base64,{qr_image_base64}" alt="Your QR Code" width="180" height="180" style="display: block;">
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td align="center" style="padding-top: 30px;">
                    ...
                    <p style="margin: 20px 0 0 0; color: #52525b; font-size: 12px;">Having trouble scanning? Present your Access ID to the security desk.</p>
                </td>
            </tr>
        </table>
